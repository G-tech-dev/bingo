  ...
  return (
    <div className="container-custom py-8">
      ...
      <div className="mb-6 flex flex-col gap-5 border-b border-dark-200 pb-6 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="font-mono text-xs font-medium uppercase tracking-[0.16em] text-primary-600">Community content</p>
          <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-dark-900">Discover organizations</h1>
          <p className="mt-2 text-sm text-dark-600">Find photos and videos from organizations helping children.</p>
        </div>
      ...
      {visibleVideos.length === 0 ? (
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-semibold text-dark-700">{videos.length === 0 ? 'No content found' : 'No matching content'}</h3>
          <p className="text-dark-500 mt-2">{videos.length === 0 ? 'Organizations have not published content yet.' : 'Try a different title, organization, or category.'}</p>
        </div>
      ) : (
