        ...
        <div className="container-custom grid items-center gap-10 py-14 sm:py-20 lg:min-h-[620px] lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:py-24">
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link to="/login" className="btn-primary inline-flex items-center justify-center gap-3 px-6 py-3">Enter the community <FaArrowRight className="text-xs" /></Link>
