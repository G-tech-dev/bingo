...
The backend provides authentication, organization media uploads, content CRUD, public video discovery, watch tracking, and wallet endpoints. Media files are stored in Cloudinary, with metadata in MongoDB.
